...
\begin{document}
  ...
  \isbn{978-1-4503-4021-2/16/06}\acmPrice{\$15.00}
  \doi{http://dx.doi.org/10.1145/2933267.2933519}
...
%, even if the processing of that timeout happens to be triggered by the current input tuple. 
