...
\begin{abstract}
The DEBS Grand Challenge is a series of challenges which address problems in event stream processing. The focus of the Grand Challenge in 2016 is on processing data streams that originate from social networks. Hence, the data represent an evolving graph structure. With this challenge we take up the general scenario and data source from the 2014 SIGMOD contest. However, in contrasts to the SIGMOD contest, the DEBS grand challenge explicitly focuses on continuous processing of streaming data and thus dynamic changes in graphs. This paper describes the specifics of the data streams and continuous queries that define the DEBS Grand Challenge 2016.
\end{abstract}
...
\todo[inline]{START: Please clarify the following paragraph -- I could not make sense of it, it relates to FAQ Question 6 (Query 1)}
...
\todo[inline]{END: Please clarify the following paragraph -- I could not make sense of it, it relates to FAQ Question 6 (Query 1)}
